          ...
          <table className="min-w-full border-collapse">
            ...
            <tfoot>
              <tr className="border-t border-gray-200">
                <td colSpan={7} className="px-4 py-3 text-sm text-right font-medium">Sub total</td>
                <td className="px-4 py-3 text-sm text-right font-medium">₹ 45,000.00</td>
              </tr>
              <tr>
                <td colSpan={7} className="px-4 py-3 text-sm text-right">Discount @ 25%</td>
                <td className="px-4 py-3 text-sm text-right">00.00</td>
              </tr>
              <tr>
              ...
              <tr>
                <td colSpan={7} className="px-4 py-3 text-sm text-right">Adjustment</td>
                <td className="px-4 py-3 text-sm text-right">00.00</td>
              </tr>
              <tr>
                <td colSpan={7} className="px-4 py-3 text-sm text-right">Round off</td>
                <td className="px-4 py-3 text-sm text-right">45,000.00</td>
              </tr>
              <tr className="bg-gray-50">
                <td colSpan={7} className="px-4 py-3 text-sm text-right font-medium">Total in ₹</td>
                <td className="px-4 py-3 text-sm text-right font-medium">₹ 45,000.00</td>
              </tr>
            </tfoot>
          </table>
